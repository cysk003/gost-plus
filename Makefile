...
android:
	gogio -x -work -target android -minsdk 22 -targetsdk 35 -version $(VERSION).11 -name GOST+ -signkey build/sign.keystore -signpass android -appid gost.plus -o $(BINDIR)/$(NAME)-$(VERSION).aab .
	gogio -x -work -target android -minsdk 22 -targetsdk 35 -version $(VERSION).11 -name GOST+ -signkey build/sign.keystore -signpass android -appid gost.plus -o $(BINDIR)/$(NAME)-$(VERSION).apk .
